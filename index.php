				   			...
				   			<div class="row">
					   			<div class="col-md-8 col-md-offset-2 text-center js-fullheight slider-text">
					   				<div class="slider-text-inner">
					   					...
					   					<h2>Uygulamalı SQL Injection 101 Derslerine hoşgeldiniz.</h2>
											<p>Bu proje içerisinde SQL Injection ile ilgili temel konular hakkında fikir ve tecrübe sahibi olacaksınız. İyi çalışmalar dilerim...</p>
					   				</div>
					   			</div>
					   		</div>
				   		</div>
					   			...
					   			<div class="col-md-8 col-md-offset-2 text-center js-fullheight slider-text">
					   				<div class="slider-text-inner">
					   					<h1>Union-based SQLi</h1>
											<h2>Union-based SQLi, iki veya daha fazla SELECT ifadesinin sonuçlarını tek bir sonuçta birleştirmek için UNION SQL operatörünü kullanan ve daha sonra HTTP yanıtının bir parçası olarak döndürülen bir tekniktir.</h2>
										</div>
					   			</div>
					   		</div>
				   		</div>
